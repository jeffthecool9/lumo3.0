// src/App.tsx — OVERWRITE with this exact file
...
export default function App() {
  ...
  // LANDING (same as your previous landing)
  return (
    <div style={{ minHeight: "100vh", background: "#F7FAFC", fontFamily: "Inter, Arial, Helvetica, sans-serif", padding: 20 }}>
      ...
      <main style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <section id="benefits" style={{ display: "grid", gap: 12, gridTemplateColumns: "1fr", marginBottom: 18 }}>
          {[ { i: "💬", t: "Responds instantly", d: "Never miss a customer — replies in seconds." }, { i: "🔁", t: "Qualifies leads automatically", d: "Collects info, filters prospects, hands you warm leads." }, { i: "⚙️", t: "Close sales in chat", d: "Send product info, payment links, and confirmations inside WhatsApp." }, { i: "🕒", t: "24/7 uptime", d: "Works around the clock — no extra staff needed." } ].map((b) => (
