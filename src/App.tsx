        ...
        {isAboutPage ? (
          ...
          <>
            ...
            <section className="pt-32 pb-12 lg:pt-48 lg:pb-24 px-6 max-w-6xl mx-auto flex flex-col items-center text-center">
              <div className="glass-glossy p-10 md:p-16 rounded-[3rem] max-w-5xl animate-float shadow-2xl mb-12 relative border border-white/60">
                ...
                <p className="text-lg md:text-xl text-slate-700 max-w-2xl mx-auto leading-relaxed font-semibold mb-10 opacity-90">
                  Every missed reply is a lost customer. Lumo responds instantly, qualifies enquiries, and hands you only
                  sales-ready buyers — even when you’re offline.
                </p>
