    ...
    <div className="min-h-screen text-slate-900 font-sans selection:bg-blue-100 selection:text-blue-900 overflow-x-hidden relative">
      ...
      <main className="relative z-10">
        ...
        <section className="pt-32 pb-12 lg:pt-48 lg:pb-24 px-6 max-w-6xl mx-auto flex flex-col items-center text-center">
          <div className="glass-glossy p-10 md:p-16 rounded-[3rem] max-w-5xl shadow-2xl mb-16 relative border border-white/60">
            ...
            <p className="text-lg md:text-xl text-slate-700 max-w-2xl mx-auto leading-relaxed font-semibold mb-10 opacity-90">
              Every missed reply is a lost customer. We build your custom chat flow to respond instantly,
              qualify enquiries, and pass sales-ready buyers to you — even when you're offline.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 w-full">
              <a
                ...
                className="flex items-center justify-center gap-3 group px-10 py-4 text-base bg-blue-600 text-white rounded-full shadow-lg shadow-blue-500/20 hover:bg-blue-700 hover:scale-[1.02] transition-all font-bold min-w-[220px]"
              >
                Chat on WhatsApp →
              </a>
